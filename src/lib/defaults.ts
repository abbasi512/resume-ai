...
export const PLACEHOLDER_RESUME_DATA: ResumeData = {
  basics: {
    ...
    summary: "Results-driven product designer with 5+ years of experience delivering high-impact digital products. Proven ability to translate complex user needs into elegant, data-backed solutions that drive measurable business outcomes.",
  },
  experience: {
    company: "Acme Corp",
...
export const TEMPLATE_INFO: Record<ResumeTemplate, { name: string; description: string; accent: string }> = {
  modern: {
    name: "Modern",
    description: "Clean and contemporary with a left accent bar",
    accent: "#2563eb",
  },
  classic: {
    name: "Classic",
